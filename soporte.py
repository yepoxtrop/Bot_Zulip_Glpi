        ...
        # - Ofrecer canales de comunicacion
            ...
            # Se pregunta al usuario si tiene un caso activo
                ...
                # Se hace una petición a al api de zulip, se carga el archivo y se envia atachado
                    ...
                    # Construye el mensaje HTML simple
                    html_content = f'[![windows.png]({image_url})]({image_url})'

                    # Envía usando el client directamente
                    msg = {
                        "type": "private",
                        "to": [user['id'] for user in message['display_recipient']],
